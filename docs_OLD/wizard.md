...
function rScript(){
  ...
  +s('links','<h4>Relevant docs</h4><ul><li><a target="_blank" rel="noopener" href="../loading-script/">Multi-trial setup guide (scripting)</a></li><li><a target="_blank" rel="noopener" href="../trialtree/">TrialTree reference</a></li><li><a target="_blank" rel="noopener" href="../examples/">Tutorial notebooks</a></li></ul>');
}
