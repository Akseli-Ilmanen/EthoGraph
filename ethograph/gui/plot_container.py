...
class PlotContainer(LabelDrawingMixin, QWidget):
    ...
    # Label/changepoint drawing inherited from LabelDrawingMixin.
    # PlotContainer keeps the vb property since it's specific to its switching logic.
