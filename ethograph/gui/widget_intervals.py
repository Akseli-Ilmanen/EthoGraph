...
class NavigationWidget(QWidget):
    ...
    def _navigate_trial(self, direction: int):
        ...
        while 0 <= new_idx < len(self.app_state.trials):
            ...
            if trial_confidence is None:
                break
            should_skip = (
                (confidence_mode == "Low confidence only" and trial_confidence == "high")
                or (confidence_mode == "High confidence only" and trial_confidence == "low")
            )
            if not should_skip:
                break
            new_idx += direction
    ...
    # ==================================================================
    # Trial condition filters (migrated from old NavigationWidget)
    # ==================================================================
    ...
    # ==================================================================
    # Playback (migrated from old NavigationWidget)
    # ==================================================================
