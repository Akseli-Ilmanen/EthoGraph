...
parser.add_argument(
    "--action", type=str, choices=["train", "eval", "inference", "CV", "feature_ablation"], default="train"
)
parser.add_argument("--result_dir", type=str, default="result")
parser.add_argument("--model_path", type=str, default=None, help="Path to model for eval/inference")
...
if all_params["action"] in ["CV", "train", "feature_ablation"] and not all_params.get(
    "trainDataReady"
):  # Skip reloading train data if already converted o
...
if args.action == "inference":
    ...
    trainer.inference(
        all_params["model_path"], features_path, batch_gen_tst, num_epochs, trial_mapping, sample_rate, all_params
    )
